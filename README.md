...
**OpenCar** is a non-discriminatory, open-standards collective dedicated to the digital future of the automotive industry. We provide the common language that allows websites, apps, and hardware to talk to one another, ensuring that automotive culture—in all its forms—thrives in a connected world.
...
If it has wheels and a community, OpenCar is built to support it.
...
1.  **Events are Discoverable:** An event posted on a local forum can be seamlessly read by a navigation app or a social discovery tool.
2.  **Data is Universal:** Vehicle specs, part fitments, and venue requirements use a single, unified syntax.
3.  **Innovation is Accessible:** Small developers and large corporations alike can build on top of a shared, professional foundation.
...
We are **not** married to any single segment of the industry. Our goal is simply to build the "pipes" that allow the entire industry to flow more efficiently.
...
1. Read the Spec: Check out the /specs directory for OC-EVENT 1.0.
2. Implement: Add OpenCar compatibility to your platform.
3. Contribute: Suggest changes or new standards via the RFC process.
   `

**OpenCar.dev** _Building the infrastructure for everything on wheels._
